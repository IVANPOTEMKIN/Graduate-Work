...
public class CodesAndDescriptions {

    public static final String CODE_200 = "200";
    public static final String DESCRIPTION_CODE_200 = "OK";
    public static final String CODE_201 = "201";
    public static final String DESCRIPTION_CODE_201 = "Created";
    public static final String CODE_204 = "204";
    public static final String DESCRIPTION_CODE_204 = "No Content";
    ...
    public static final String CODE_417 = "417";
    public static final String DESCRIPTION_CODE_417 = "Expectation Failed";
